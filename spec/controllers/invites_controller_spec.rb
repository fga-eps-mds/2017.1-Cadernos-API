...
RSpec.describe InvitesController, type: :controller do
  ...
  describe "GET #edit" do
    it "assigns the requested invite as @invite" do
      invite = Invite.create! valid_attributes
      get :edit, params: {id: invite.to_param}, session: valid_session
      expect(assigns(:invite)).to eq(invite)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created invite" do
        post :create, params: {invite: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Invite.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested invite" do
        invite = Invite.create! valid_attributes
        put :update, params: {id: invite.to_param, invite: new_attributes}, session: valid_session
        invite.reload
      ...
      it "assigns the requested invite as @invite" do
        invite = Invite.create! valid_attributes
        put :update, params: {id: invite.to_param, invite: valid_attributes}, session: valid_session
        expect(assigns(:invite)).to eq(invite)
      end
    ...
    context "with invalid params" do
      it "assigns the invite as @invite" do
        invite = Invite.create! valid_attributes
        put :update, params: {id: invite.to_param, invite: invalid_attributes}, session: valid_session
        expect(assigns(:invite)).to eq(invite)
      end
